...
This is the repository for the LinkedIn Learning course `Build with AI: Agentic Applications with LlamaIndex and MCP`. The full course is available from [LinkedIn Learning][lil-course-url].
